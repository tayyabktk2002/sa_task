        ...
        <header className="sticky top-0 z-50 w-full bg-white/85 backdrop-blur-md border-b border-slate-200/80 shadow-[0_1px_24px_0_rgba(99,102,241,0.06),0_1px_4px_0_rgba(0,0,0,0.04)]">
            <div className="flex items-center justify-between px-6 h-16 gap-4">
                ...
                <div className="flex-1 max-w-sm relative">
                    <svg
                        className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none transition-colors duration-200 ${searchFocused ? 'text-indigo-500' : 'text-slate-400'}`}
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-800 placeholder:text-slate-400 outline-none transition-all duration-200 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/15"
                    />
                </div>
                        ...
                        {dropdownOpen && (
                            <div className="absolute top-[calc(100%+10px)] right-0 w-56 bg-white border border-slate-200 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.12),0_2px_8px_rgba(99,102,241,0.08)] z-100 overflow-hidden">
                                <div className="px-4 py-3 border-b border-slate-100">
                                    ...
                                    <p className="text-xs text-slate-400 mt-0.5 overflow-hidden text-ellipsis whitespace-nowrap">{orgName || userRole}</p>
                                </div>
